...
Route::middleware([
    ...
    //     Route::get('/', 'Tenant\HomeController@dashboard')->name('home');
    //     Route::get('/home', 'Tenant\HomeController@dashboard')->name('home');
    //     Route::get('/dashboard', 'Tenant\HomeController@dashboard')->name('dashboard');
    ...
    // Route::get('/login', 'Tenant\Auth\TenantLoginController@showLoginForm');
    // Route::post('/login', 'Tenant\Auth\TenantLoginController@login');
    // Route::post('/logout', 'Tenant\Auth\TenantLoginController@logout');

    // // Registration Routes...
    // Route::get('/register', 'Tenant\Auth\RegisterController@showRegistrationForm')->name('register');
    // Route::post('/register', 'Tenant\Auth\RegisterController@register');

    // // Password Reset Routes...
    // Route::get('/password/reset', 'Tenant\Auth\ForgotPasswordController@showLinkRequestForm');
    // Route::post('/password/email', 'Tenant\Auth\ForgotPasswordController@sendResetLinkEmail');
    // Route::get('/password/reset/{token}', 'Tenant\Auth\ResetPasswordController@showResetForm');
    // Route::post('/password/reset', 'Tenant\Auth\ResetPasswordController@reset');
